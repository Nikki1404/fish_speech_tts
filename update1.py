...
python client.py --mode openai --server http://localhost:8003/v1/audio/speech --text "I cannot believe we finally made it!" --language English --speaker Aiden --instruct "Speak happily and with excitement." --response-format wav --output openai.wav --play
